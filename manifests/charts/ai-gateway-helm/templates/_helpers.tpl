...
{{- printf "%s-%s" (include "ai-gateway-helm.controller.serviceAccountName" .) (default "default" .Release.Namespace) | trunc 253 | trimSuffix "-" }}
{{- end }}

{{- define "ai-gateway-helm.inference-pool.clusterRoleName" -}}
{{- printf "%s-%s" "envoy-ai-gateway-inference-pool-reader" (default "default" .Release.Namespace) | trunc 253 | trimSuffix "-" }}
{{- end -}}

{{- define "ai-gateway-helm.inference-pool.clusterRoleBindingName" -}}
{{- printf "%s-%s" "envoy-ai-gateway-inference-pool-reader-binding" (default "default" .Release.Namespace) | trunc 253 | trimSuffix "-" }}
{{- end -}}
